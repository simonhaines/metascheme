...
; Libraries/modules
(define (provide? exp) (tagged-list? exp 'provide))
...
; Export table (provide ...)
(define exported-definitions '())
(define (add-exported-definition def)
  (set! exported-definitions (cons def exported-definitions)))
...
(define (compile exp target c-t-env)
  (cond ((self-evaluating? exp)  (compile-self-evaluating exp target c-t-env))
        ...
        ((provide? exp) (compile-provide exp target c-t-env))
...
(define bootstrap-llvm-code-legacy
  '("declare void @db_trace(i8*, i32, ...)"
    ...
    "declare i64 @allocate-object(i64*, i64*)"
    "declare i64 @allocate-string-or-symbol(i64*, i64*)"
    "declare i64 @apply-procedure(i64*, i64*)"
    "declare i64 @object-ref(i64*, i64*)"
    "declare i64 @object-ref(i64*, i64*)"
    "declare i64 @object-ref(i64*, i64*)"


    "declare i64 @llvm-read-char()"
    "declare i64 @make-null()"
    "declare i64 @make-true()"
    "declare i64 @make-number(i64)"
    "declare i64 @make-procedure(i64 (i64*)*, i64*, i64*)"
    "declare i64 @make-string-or-symbol(i64, i64*, i64*)"
    "declare i64 @mem-cpy(i64*, i64*, i64*)"
    "declare i64 @null(i64*)"
    "declare i64 @number(i64*)"
    "declare i64 @object-ref(i64*, i64*)"
    "declare i64 @object-set(i64*, i64*, i64*)"
    "declare i64 @object-size(i64*)"
    "declare i64 @print-number(i64*, i64*)"
    "declare i64 @print-string-or-symbol(i64*)"
    "declare i64 @procedure(i64*)"
    "declare i64 @raw-number(i64*)"
    "declare i64 @string-or-symbol(i64*)"
    "declare i64 @string-ref(i64*, i64*)"
    "declare i64 @string-set(i64*, i64*, i64*)"
    "declare i64 @vector(i64*)"
